...
import control.ControladorEscribirMensajeMedico;
import model.Conexion;

public class VentanaEscribirMensajeMedico extends JFrame {
	
	private JPanel contentPane;
	public ControladorEscribirMensajeMedico cemm;
	Conexion datos= new Conexion("EasyCardio.db");
	 ...
	 public void crearVista() {
		...
		JLabel lblNewLabel_1 = new JLabel(VentanaLogin.textField_1.getText().toLowerCase().toString());
		
		JLabel lblPaciente = new JLabel("PACIENTE : ");
		
		JLabel lblNewLabel_2 = new JLabel(datos.ConsultaPacienteNombre(VentanaMedicoGrafica.id));
		...
		setVisible(true);
		btnAgregarComentario.addActionListener(cemm);
	}		
	
	public void addController (ControladorEscribirMensajeMedico _cemm){
