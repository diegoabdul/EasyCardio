...
import control.ControladorVerMensajeMedico;
import model.Conexion;

public class VentanaVerMensajeMedico extends JFrame {
	
	private JPanel contentPane;
	public ControladorVerMensajeMedico cvmm;
	...
	public void crearVista() {
		...
		gl_contentPane.setHorizontalGroup(
			...
			ResultSet rs = datos.VerMensajes(datos.ConsultaPacienteNombre(VentanaMedicoGrafica.id).toString());
		...
		table.addMouseListener(cvmm);
		scrollPane.setViewportView(table);
		contentPane.setLayout(gl_contentPane);
		setVisible(true);
	}
	public void addController (ControladorVerMensajeMedico _cvmm){
